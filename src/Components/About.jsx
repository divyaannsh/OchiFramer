...
function About() {
  return (
    <div className="w-full h-full min-h-screen p-20 bg-[#CDEA68] rounded-tl-3xl rounded-tr-3xl">
     <h1 className="font-['Neue_MonTreal'] text-[5vw] font-bold leading-[4.5vw]  m-0 tracking-tight">
      ...
      <div className="w-full flex gap-5 border-t-[1px] pt-10 mt-20 border-[#a1b562]">
        <div className="w-1/2">
          <h1 className="text-7xl font font-semibold">Our Approach</h1>
